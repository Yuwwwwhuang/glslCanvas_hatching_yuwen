...
void main() {
    ...
    vec3 hatch0 = vec3(texhv(uv*5.0, tex0.g+0.3));
    vec3 hatch1 = vec3(texh(uv*5.0, tex1.g+0.4-breathing*0.4));
    //vec3 hatch1 = vec3(texh(uv*5.0, tex1.g));
